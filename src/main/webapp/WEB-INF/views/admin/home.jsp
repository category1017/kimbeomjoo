      ...
      <div class="container-fluid">
      	...
      	<div class="card">
            <div class="card-header">
              <h3 class="card-title">최근 등록한 회원목록</h3>
          ...
          <div class="card-body p-0">
              ...
              <c:forEach items="${latest_member}" var="memberVO">
                ...
                -->
                <img onerror="this.src='/resources/dist/img/default-150x150.png'" src="/resources/profile/${memberVO.user_id}.jpg" alt="사용자 프로필" style="width:120px;height:120px;"/>
                 <div>
	                  ${memberVO.user_name}
              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tbody>
                    <!-- 대시보드 만들기 2번째 방법(아래) -->
                    <!-- 파일 import시 매개변수 board_type=${boardTypeVO.board_type}-->
